...
import medianPriceSuburbData from '../data/Median_price_suburb';
...
const BarChartComponent = () => {
  ...
  //change data when suburb value change
  ...
  //change data on chart depend on attempt that user select
  ...
  return (
    <div>
      <h2 className='text-capitalize'>Comparative Median Prices Across Suburbs (2020-2023)</h2>
      <p className='chart-desc'>
      This chart allows users to compare the median prices of different suburbs over the years 2020 to 2023. Users can select specific attempts to see how the prices vary across different suburbs.
      </p>
